...
class TestConversion:
    ...
    async def test_edifact_to_bo4e(self, unauthenticated_client: TransformerBeeClient):
    ...
    async def test_bo4e_to_edifact(self, unauthenticated_client: TransformerBeeClient):
